...
public class Docente extends Usuario implements Serializable{
    ...
    public Docente(String NombreUsuario, String ApellidoUsuario, String CorreoUsuario, String PasswordUsuario, 
        ...
        super(NombreUsuario, ApellidoUsuario, CorreoUsuario, PasswordUsuario, ImagenUsuario, CedulaUsuario, 
